        ...
        <div className="container mx-auto flex h-20 items-center justify-between px-4 md:px-6">
          ...
          <nav className="hidden items-center gap-6 md:flex">
            <Link href="#product" className="group relative text-sm font-medium text-muted-foreground transition-colors hover:text-primary">
              Product
              <span className="absolute bottom-0 left-0 h-0.5 w-full scale-x-0 bg-gradient-to-r from-primary to-accent transition-transform duration-300 ease-out group-hover:scale-x-100"></span>
            </Link>

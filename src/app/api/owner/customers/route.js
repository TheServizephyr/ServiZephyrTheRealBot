...
export async function GET(req) {
    try {
        ...
        const { businessId, collectionName } = await verifyOwnerFeatureAccess(req, 'customers', 'view_customers');
...
export async function PATCH(req) {
    try {
        const firestore = await getFirestore();
        const { businessId, collectionName } = await verifyOwnerFeatureAccess(req, 'customers', 'update_customer');

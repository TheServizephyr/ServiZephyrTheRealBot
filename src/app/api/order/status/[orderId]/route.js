    ...
    try {
        ...
        const responsePayload = {
            order: {
                ...
                diningPreference: orderData.diningPreference || null,
                packagingCharge: Number(orderData.packagingCharge || 0),
                discount: Number(orderData.discount || 0),
                coupon: orderData.coupon ? {
                    code: orderData.coupon.code || null,
                    discount: orderData.coupon.discount || null,
                    type: orderData.coupon.type || null,
                    value: orderData.coupon.value || null,
                } : null,
                convenienceFee: Number(orderData.convenienceFee || 0),
                platformFee: Number(orderData.platformFee || 0),
                tipAmount: Number(orderData.tipAmount || 0),
                grandTotal: aggregatedTotal || orderData.totalAmount || orderData.grandTotal || 0,
